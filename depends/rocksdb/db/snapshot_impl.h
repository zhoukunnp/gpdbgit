...
class SnapshotImpl : public Snapshot {
 public:
  SnapshotImpl(): number_(0), prev_(NULL), next_(NULL), list_(NULL),
  unix_time_(0), is_write_conflict_boundary_(false){

  }

  SnapshotImpl(SequenceNumber number): number_(number), prev_(NULL), next_(NULL), list_(NULL),
        unix_time_(0), is_write_conflict_boundary_(false)
  {
  }
