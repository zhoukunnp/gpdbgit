...
class PessimisticTransaction : public TransactionBaseImpl {
 public:
  ...
  Status CommitWithTS(const SequenceNumber commit_ts) override;
  Status CommitWithLTS(const SequenceNumber commit_ts, const uint32_t lts) override;
 ...
 protected:
  ...
  virtual Status CommitWithoutPrepareInternalWithTS(SequenceNumber commit_ts, uint32_t lts) = 0;
  ...
  virtual Status CommitInternalWithTS(SequenceNumber commit_ts, uint32_t lts) = 0;
