...
class WriteBatch : public WriteBatchBase {
 public:
  ...
  void SetLTS(const uint64_t lts) { lts_ = lts; user_key_reconstruct = true; }
  uint32_t GetLTS() const { return lts_; }

  bool GetTransferValid() const {return user_key_reconstruct; }
