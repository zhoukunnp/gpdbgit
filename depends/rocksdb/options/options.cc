...
void ReadOptions::SetSequence(SequenceNumber sequence)
    {
        //std::unique_ptr<SnapshotImpl> snapshoti (new SnapshotImpl(sequence));
        // SnapshotImpl *snapshoti = 
        //SnapshotImpl snapshoti(sequence);
        snapshot = new SnapshotImpl(sequence);
    }
}  // namespace rocksdb
