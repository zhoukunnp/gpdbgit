...
TupleValueSlice
rocks_engine_get(KVEngineInterface* interface, TupleKeySlice key)
{
	RocksEngine* rocks_engine = (RocksEngine*) interface;
...
TupleValueSlice
rocks_engine_batch_get(KVEngineInterface* interface, KVEngineBatchInterface* batch_interface, TupleKeySlice key)
{
	RocksEngine* rocks_engine = (RocksEngine*) interface;
	RocksBatchEngine* rocks_batch = (RocksBatchEngine*) batch_interface;
	TupleValueSlice value = {NULL, 0};
