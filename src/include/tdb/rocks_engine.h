...
extern TupleValueSlice rocks_engine_get(KVEngineInterface* interface, TupleKeySlice key);
...
extern TupleValueSlice rocks_engine_batch_get(KVEngineInterface* interface, KVEngineBatchInterface* batch_interface, TupleKeySlice key);
...
extern HTAB *transaction_env_htab;
