...
extern bool kvengine_send_put_rts_req(TupleKeySlice key, TupleValueSlice value, RangeID rangeid);
...
extern ScanResponse* kvengine_send_index_scan_req(TupleKeySlice startkey, TupleKeySlice endkey, Snapshot snap, bool forward, bool second, int req_type, CmdType Scantype);
